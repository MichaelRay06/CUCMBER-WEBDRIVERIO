exports.config = {
    ...
    specs: [
      // './features/**/basket.feature',
        './features/**/login.amazone.feature',
   ...
   services: ['selenium-standalone'],
    ...
    cucumberOpts: {
        ...
        require: ['./features/step-definitions/test.steps.js',
          //'./features/step-definitions/amazone.addbasket.steps.js',
      // './features/step-definitions/amazone.search.steps.js',
      './features/step-definitions/amazone.login.steps.js'
     ...
     */
     beforeScenario: function (uri, feature, scenario, sourceLocation, context) {
         ...
         browser.addCommand('waitAndSetTextValue', function (selector, text){
             try{
                 $(selector).waitForExist()
                 $(selector).setValue(text)

             }catch (error) {
                 throw new Error (`could not setTextValue:  ${text} in the textBox: ${selector}`)
